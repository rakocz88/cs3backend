...
public class Cs3BackendApp {

    private static final Logger log = LoggerFactory.getLogger(Cs3BackendApp.class);

    private final Environment env;

    public Cs3BackendApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes cs3backend.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Cs3BackendApp.class);
